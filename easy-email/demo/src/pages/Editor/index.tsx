...
import { Popup } from '@demo/components/Popup';
...
export default function Editor() {
  ...
  const onSubmit = useCallback(
    async (
      ...
      var url = popupInputValue;

      var respJson = await fetch('http://127.0.0.1:105/gettemplate?url=' + url).then(response => response.json())
      console.log(respJson.response)

      var jsonStr = MjmlToJson(respJson.response)

      form.restart({
        subject: 'Hello hello',
        subTitle: 'Nice to meet you sir',
        content: jsonStr,
      });
      ...
      //   },
      // });
      // console.log('oh its like that huh');
    ...
    [dispatch, history, id, initialValues, popupInputValue],
  );
            ...
            return (
              <>
                ...
                <Popup
                  ...
                  setInputValue={setPopupInputValue}
                />
              </>
            );
          }}
